...
class BlusmartSearchEndLocation extends StatefulWidget {
  const BlusmartSearchEndLocation({super.key});

  @override
  State<BlusmartSearchEndLocation> createState() =>
      _BlusmartSearchEndLocationState();
}

class _BlusmartSearchEndLocationState extends State<BlusmartSearchEndLocation> {
